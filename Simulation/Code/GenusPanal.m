...
analysisLevel = "genus";   % "genus" or "phylum"
...
function createFinal_CASCA_oMEDA_Panel( ...
    ...
    L_plot, taxaNames, SigLoad, O, omedaMethodNames, outBase)
    ...
    plotPanelLoadingHeatmap(axDmain, axDtaxa, axDcb, L_plot, taxaNames, ["Disagreement","Consensus"], SigLoad);
    ...
    plotPanelOmedaHeatmap_NoTaxa(axEmain, axEcb, O, omedaMethodNames);
