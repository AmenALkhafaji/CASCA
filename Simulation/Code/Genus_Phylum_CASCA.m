...
%        star   = group-related parglmMC significance
%                 suppressed when displayed oMEDA value is 0
%
%  Important:
...
% The same group-effect significance is repeated across all five oMEDA
...
Sig_OMEDA_raw = repmat(p_consensus(:) <= alpha, 1, 5);
